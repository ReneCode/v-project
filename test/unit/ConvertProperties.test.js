...
const convertProperties = require('../../src/service/convert-properties');
...
describe('ConvertProperties', () => {
  it('should convertProperties of one object', () => {
    let o = convertProperties(getPage(7, "bla"));
  ...
  it('should convertProperties of array oj objects', () => {
    ...
    let os = convertProperties(objs);
    expect(os).to.not.not.null;
